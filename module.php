...
class SolarFlowEnergy extends IPSModule
{
    public function __construct($InstanceID = 0)
    {
        // IP-Symcon übergibt die Instanz-ID automatisch. Der Default verhindert
        // den Fehler "Wrong parameter count", wenn die Klasse versehentlich
        // ohne Instanz-ID testweise instanziiert wird.
        if ($InstanceID > 0) {
