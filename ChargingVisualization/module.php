    ...
    public function RequestAction($Ident, $Value)
    {
        switch ($Ident) {
            ...
            case 'HomeGridChargeEnabled':
                $this->SetConfiguredValue('HomeGridChargeEnabledVariable', (bool)$Value);
                break;
            case 'HomeWindow1':
    ...
    private function BuildPayload(): array
    {
        ...
        return [
            ...
            'homeBattery' => [
                ...
                'windows' => [
                    [
                        'start' => strval($this->V('HomeWindow1StartVariable', '00:00')),
                        'end' => strval($this->V('HomeWindow1EndVariable', '06:00')),
                        'targetSoc' => floatval($this->V('HomeWindow1SocVariable', 60))
                    ],
                    [
                        'start' => strval($this->V('HomeWindow2StartVariable', '13:00')),
                        'end' => strval($this->V('HomeWindow2EndVariable', '15:00')),
                        'targetSoc' => floatval($this->V('HomeWindow2SocVariable', 80))
                    ]
                ]
            ]
        ];
